...
@st.cache_data
def load_data():
    df = pd.read_csv("https://github.com/143Himanshujangid/crryptocurrency/blob/main/st2/cleaned_sorted_output_cleaned.csv")  # Adjust path if needed
    return df
...
if __name__ == "__main__":
    main()  # Correctly placed the main function call
